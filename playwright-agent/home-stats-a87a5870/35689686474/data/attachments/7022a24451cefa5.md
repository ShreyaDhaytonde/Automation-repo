...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Archive Habit 1790054297016' }).getByRole('checkbox', { name: 'Archive Archive Habit 1790054297016' })
  ...
  - main [ref=e3]:
    ...
    - list [ref=e38]:
      - listitem [ref=e39]:
        - generic:
          - generic:
            - paragraph [ref=e40]: Archive Habit 1790054233190
        ...
        - generic [ref=e43]:
          ...
          - button "Freeze Archive Habit 1790054233190 for today" [ref=e45]: 🧊 Freeze
          - button "Edit Archive Habit 1790054233190" [ref=e46]: Edit
          - button "Duplicate Archive Habit 1790054233190" [ref=e47]: Duplicate
          - button "Archive Archive Habit 1790054233190" [ref=e48]: Archive
          - button "Delete Archive Habit 1790054233190" [ref=e49]: Remove
      - listitem [ref=e50]:
        - generic:
          - generic:
            - paragraph [ref=e51]: Archive Habit 1790054297016
        ...
        - generic [ref=e54]:
          ...
          - button "Freeze Archive Habit 1790054297016 for today" [ref=e56]: 🧊 Freeze
          - button "Edit Archive Habit 1790054297016" [ref=e57]: Edit
          - button "Duplicate Archive Habit 1790054297016" [ref=e58]: Duplicate
          - button "Archive Archive Habit 1790054297016" [ref=e59]: Archive
          - button "Delete Archive Habit 1790054297016" [ref=e60]: Remove
      - listitem [ref=e61]:
        - generic:
          - generic:
            - paragraph [ref=e62]: Skip Habit 1790054105742
        ...
        - generic [ref=e65]:
          ...
          - button "Freeze Skip Habit 1790054105742 for today" [ref=e67]: 🧊 Freeze
          - button "Edit Skip Habit 1790054105742" [ref=e68]: Edit
          - button "Duplicate Skip Habit 1790054105742" [ref=e69]: Duplicate
          - button "Archive Skip Habit 1790054105742" [ref=e70]: Archive
          - button "Delete Skip Habit 1790054105742" [ref=e71]: Remove
      - listitem [ref=e72]:
        - generic:
          - generic:
            - paragraph [ref=e73]: Skip Habit 1790054169424
        ...
        - generic [ref=e76]:
          ...
          - button "Freeze Skip Habit 1790054169424 for today" [ref=e78]: 🧊 Freeze
          - button "Edit Skip Habit 1790054169424" [ref=e79]: Edit
          - button "Duplicate Skip Habit 1790054169424" [ref=e80]: Duplicate
          - button "Archive Skip Habit 1790054169424" [ref=e81]: Archive
          - button "Delete Skip Habit 1790054169424" [ref=e82]: Remove
  - alert [ref=e83]
```
...
> 143 |     await habitCard.getByRole('checkbox', { name: `Archive ${habitName}` }).check();
  ...
  227 | 
  228 |   /**
  229 |    * TC12: HabitForm - adds a new habit successfully
  230 |    */
  231 |   test('TC12 - HabitForm - adds a new habit successfully', async ({ page }) => {
  232 |     await page.goto('/');
  233 |     const uniqueName = `Habit ${Date.now()}`;
  234 |     await page.getByRole('textbox', { name: 'New habit name' }).fill(uniqueName);
  235 |     await page.getByLabel('Habit category').selectOption('General');
  236 |     await page.getByLabel('Times per week').selectOption('7');
  237 |     await page.getByRole('textbox', { name: 'Notes (optional)' }).fill('Test notes');
  238 |     await page.getByRole('button', { name: 'Add habit' }).click();
  239 |     const habitItem = page.getByRole('listitem').filter({ hasText: uniqueName });
  240 |     await expect(habitItem).toBeVisible();
  241 |   });
  242 | 
  243 |   /**
```