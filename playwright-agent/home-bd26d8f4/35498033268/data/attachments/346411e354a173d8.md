...
Locator: getByRole('listitem').filter({ hasText: 'Test Delete 1789890896309' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Test Delete 1789890896309' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Test Delete 1789890896309' })
