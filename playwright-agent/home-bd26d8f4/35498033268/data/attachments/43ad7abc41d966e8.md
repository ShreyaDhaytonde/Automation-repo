...
Call log:
  ...
  - waiting for getByRole('button', { name: /^Complete all for today/ })
    16 × locator resolved to <button class="rounded-full bg-emerald-600 px-3 py-1 text-sm font-medium text-white shadow-sm transition-colors hover:bg-emerald-700 disabled:opacity-50 disabled:hover:bg-emerald-600">Complete all for today (17)</button>
