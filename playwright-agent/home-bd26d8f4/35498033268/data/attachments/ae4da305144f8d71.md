...
Locator:  getByRole('listitem').filter({ hasText: 'Test Delete 1789890908511' })
Expected: 0
Received: 1
Timeout:  10000ms

Call log:
  - Expect "toHaveCount" getByRole('listitem').filter({ hasText: 'Test Delete 1789890908511' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Test Delete 1789890908511' })
  ...
  - main [ref=f1e3]:
    ...
    - list [ref=f1e12]:
      - listitem [ref=f1e13]:
        - generic:
          - generic:
            - paragraph [ref=f1e14]: Test Delete 1789890908511
            - generic [ref=f1e15]: General
            - status "Test Delete 1789890908511 is at risk of missing its weekly goal" [ref=f1e16]: ⏰ Due today
          - paragraph: Start your streak today!
          - generic:
            - progressbar "Test Delete 1789890908511 weekly progress"
            - generic [ref=f1e17]: 0/7 this week
        - generic [ref=f1e18]:
          - button "Mark done" [disabled] [ref=f1e19]
          - button "Freeze Test Delete 1789890908511 for today" [disabled] [ref=f1e20]: 🧊 Freeze
          - button "Edit Test Delete 1789890908511" [ref=f1e21]: Edit
          - button "Duplicate Test Delete 1789890908511" [ref=f1e22]: Duplicate
          - button "Unarchive Test Delete 1789890908511" [ref=f1e23]: Unarchive
          - button "Delete Test Delete 1789890908511" [active] [ref=f1e24]: Remove
  - alert [ref=f1e25]
```
