...
Locator: getByRole('listitem').filter({ hasText: 'CompleteTest 1789732039850' }).getByRole('button', { name: 'Mark done' })
Expected: disabled
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeDisabled" getByRole('listitem').filter({ hasText: 'CompleteTest 1789732039850' }).getByRole('button', { name: 'Mark done' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'CompleteTest 1789732039850' }).getByRole('button', { name: 'Mark done' })
