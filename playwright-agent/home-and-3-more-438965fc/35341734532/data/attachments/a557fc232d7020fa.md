...
- Name: archive.spec.ts >> Archive >> TC02 - Archive page - renders with heading and controls
- Location: tests/archive.spec.ts:29:7
...
- main:
  ...
  - list:
    - listitem:
      - paragraph: ArchiveTest 1789732075860
      - text: General
      - status "ArchiveTest 1789732075860 is at risk of missing its weekly goal": ⏰ Due today
      - paragraph: Start your streak today!
      - progressbar "ArchiveTest 1789732075860 weekly progress"
      - text: 0/7 this week
      - button "Mark done" [disabled]
      - button "Freeze ArchiveTest 1789732075860 for today" [disabled]: 🧊 Freeze
      - button "Edit ArchiveTest 1789732075860": Edit
      - button "Unarchive ArchiveTest 1789732075860": Unarchive
      - button "Delete ArchiveTest 1789732075860": Remove
- alert
```
