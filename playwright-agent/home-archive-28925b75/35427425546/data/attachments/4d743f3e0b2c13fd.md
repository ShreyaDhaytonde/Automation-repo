...
Locator: getByRole('listitem').filter({ hasText: 'DeleteTest 1789800943379' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'DeleteTest 1789800943379' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'DeleteTest 1789800943379' })
