...
Locator:  getByRole('listitem').filter({ hasText: 'Test Delete 1789800396679' })
Expected: 0
Received: 1
Timeout:  10000ms

Call log:
  - Expect "toHaveCount" getByRole('listitem').filter({ hasText: 'Test Delete 1789800396679' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Test Delete 1789800396679' })
    ...
    - list [ref=f1e12]:
      - listitem [ref=f1e13]:
        ...
        - generic [ref=f1e18]:
          ...
          - button "Delete Test Delete 1789800396679" [active] [ref=f1e24]: Remove
  - alert [ref=f1e25]
```
