...
Locator: getByRole('listitem').filter({ hasText: 'CompleteTest 1789800919294' }).getByRole('button', { name: 'Mark done' })
Expected: disabled
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeDisabled" getByRole('listitem').filter({ hasText: 'CompleteTest 1789800919294' }).getByRole('button', { name: 'Mark done' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'CompleteTest 1789800919294' }).getByRole('button', { name: 'Mark done' })
...
- main:
  ...
  - list:
    ...
    - listitem:
      - paragraph: CompleteTest 1789800919294
      - text: General
      - paragraph: 🔥 1 day streak
      - progressbar "CompleteTest 1789800919294 weekly progress"
      - text: 1/7 this week
      - button "Done today" [disabled]
      - button "Freeze CompleteTest 1789800919294 for today" [disabled]: 🧊 Freeze
      - button "Edit CompleteTest 1789800919294": Edit
      - button "Duplicate CompleteTest 1789800919294": Duplicate
      - button "Archive CompleteTest 1789800919294": Archive
      - button "Delete CompleteTest 1789800919294": Remove
    - listitem:
