...
- Name: home.spec.ts >> Home >> TC08 - Clear filters button - resets all filters
- Location: tests/home.spec.ts:211:7
...
Call log:
  - waiting for getByRole('searchbox', { name: 'Search habits by name' })
