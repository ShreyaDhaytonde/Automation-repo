...
- Name: home.spec.ts >> Home >> TC16 - Category filter - allows filtering habits
- Location: tests/home.spec.ts:375:7
...
Call log:
  - waiting for getByRole('combobox', { name: 'Filter by category' })
