...
- Name: archive.spec.ts >> Archive page >> TC02 - Archive page - can delete an archived habit
...
Locator: getByRole('listitem').filter({ hasText: 'Test Delete 1789748137389' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Test Delete 1789748137389' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Test Delete 1789748137389' })
