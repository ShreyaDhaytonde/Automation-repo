...
Locator:  getByRole('listitem').filter({ hasText: 'Updated habit 1789982120916' }).getByText('Updated notes')
Expected: visible
Received: hidden
Timeout:  10000ms

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Updated habit 1789982120916' }).getByText('Updated notes') with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Updated habit 1789982120916' }).getByText('Updated notes')
