...
Locator:  getByRole('listitem').filter({ hasText: 'Updated habit 1789982133330' }).getByText('Updated notes')
Expected: visible
Received: hidden
Timeout:  10000ms

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Updated habit 1789982133330' }).getByText('Updated notes') with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Updated habit 1789982133330' }).getByText('Updated notes')
...
- main:
  ...
  - list:
    - listitem:
      - paragraph: CompleteTest-1789982033136
      - text: General
      - paragraph: Start your streak today!
      - progressbar "CompleteTest-1789982033136 weekly progress"
      - text: 0/3 this week
      - button "Mark done"
      - button "Freeze CompleteTest-1789982033136 for today": 🧊 Freeze
      - button "Edit CompleteTest-1789982033136": Edit
      - button "Duplicate CompleteTest-1789982033136": Duplicate
      - button "Archive CompleteTest-1789982033136": Archive
      - button "Delete CompleteTest-1789982033136": Remove
    - listitem:
      - paragraph: Test habit 1789982096494
      - text: Health
      - paragraph: Start your streak today!
      - progressbar "Test habit 1789982096494 weekly progress"
      - text: 0/3 this week
      - paragraph: Test note for habit
      - button "Mark done"
      - button "Freeze Test habit 1789982096494 for today": 🧊 Freeze
      - button "Edit Test habit 1789982096494": Edit
      - button "Duplicate Test habit 1789982096494": Duplicate
      - button "Archive Test habit 1789982096494": Archive
      - button "Delete Test habit 1789982096494": Remove
    - listitem:
      - paragraph: Test habit 1789982108809
      - text: Health
      - paragraph: Start your streak today!
      - progressbar "Test habit 1789982108809 weekly progress"
      - text: 0/3 this week
      - paragraph: Test note for habit
      - button "Mark done"
      - button "Freeze Test habit 1789982108809 for today": 🧊 Freeze
      - button "Edit Test habit 1789982108809": Edit
      - button "Duplicate Test habit 1789982108809": Duplicate
      - button "Archive Test habit 1789982108809": Archive
      - button "Delete Test habit 1789982108809": Remove
    - listitem:
      - paragraph: Updated habit 1789982120916
      - text: Personal
      - paragraph: Start your streak today!
      - progressbar "Updated habit 1789982120916 weekly progress"
      - text: 0/5 this week
      - paragraph: Updated notes
      - button "Mark done"
      - button "Freeze Updated habit 1789982120916 for today": 🧊 Freeze
      - button "Edit Updated habit 1789982120916": Edit
      - button "Duplicate Updated habit 1789982120916": Duplicate
      - button "Archive Updated habit 1789982120916": Archive
      - button "Delete Updated habit 1789982120916": Remove
    - listitem:
      - paragraph: Updated habit 1789982133330
      - text: Personal
      - paragraph: Start your streak today!
      - progressbar "Updated habit 1789982133330 weekly progress"
      - text: 0/5 this week
      - paragraph: Updated notes
      - button "Mark done"
      - button "Freeze Updated habit 1789982133330 for today": 🧊 Freeze
      - button "Edit Updated habit 1789982133330": Edit
      - button "Duplicate Updated habit 1789982133330": Duplicate
      - button "Archive Updated habit 1789982133330": Archive
      - button "Delete Updated habit 1789982133330": Remove
- alert
```
