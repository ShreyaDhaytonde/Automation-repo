...
Locator:  getByRole('listitem').filter({ hasText: 'Updated habit 1789981633044' }).getByText('Updated notes')
Expected: visible
Received: hidden
Timeout:  10000ms

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Updated habit 1789981633044' }).getByText('Updated notes') with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Updated habit 1789981633044' }).getByText('Updated notes')
...
- main:
  ...
  - list:
    ...
    - listitem:
      - paragraph: Updated habit 1789981620434
      - text: Personal
      - paragraph: Start your streak today!
      - progressbar "Updated habit 1789981620434 weekly progress"
      - text: 0/5 this week
      - paragraph: Updated notes
      - button "Mark done"
      - button "Freeze Updated habit 1789981620434 for today": 🧊 Freeze
      - button "Edit Updated habit 1789981620434": Edit
      - button "Duplicate Updated habit 1789981620434": Duplicate
      - button "Archive Updated habit 1789981620434": Archive
      - button "Delete Updated habit 1789981620434": Remove
    - listitem:
      - paragraph: Updated habit 1789981633044
      - text: Personal
      - paragraph: Start your streak today!
      - progressbar "Updated habit 1789981633044 weekly progress"
      - text: 0/5 this week
      - paragraph: Updated notes
      - button "Mark done"
      - button "Freeze Updated habit 1789981633044 for today": 🧊 Freeze
      - button "Edit Updated habit 1789981633044": Edit
      - button "Duplicate Updated habit 1789981633044": Duplicate
      - button "Archive Updated habit 1789981633044": Archive
      - button "Delete Updated habit 1789981633044": Remove
- alert
```
