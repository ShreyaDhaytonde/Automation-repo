...
Locator:  getByRole('listitem').filter({ hasText: 'Test habit 1789981595980' }).getByText('Test note for habit')
Expected: visible
Received: hidden
Timeout:  10000ms

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Test habit 1789981595980' }).getByText('Test note for habit') with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Test habit 1789981595980' }).getByText('Test note for habit')
