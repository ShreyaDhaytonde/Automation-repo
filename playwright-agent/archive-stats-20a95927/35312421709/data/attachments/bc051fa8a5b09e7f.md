...
Locator: getByRole('listitem').filter({ hasText: 'Search Habit 1789710997943' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Search Habit 1789710997943' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Search Habit 1789710997943' })
...
- main:
  ...
  - list:
    ...
    - listitem:
      - paragraph: Search Habit 1789710985822
      - text: General
      - status "Search Habit 1789710985822 is at risk of missing its weekly goal": ⏰ Due today
      - paragraph: Start your streak today!
      - progressbar "Search Habit 1789710985822 weekly progress"
      - text: 0/7 this week
      - button "Mark done"
      - button "Freeze Search Habit 1789710985822 for today": 🧊 Freeze
      - button "Edit Search Habit 1789710985822": Edit
      - button "Archive Search Habit 1789710985822": Archive
      - button "Delete Search Habit 1789710985822": Remove
    - listitem:
