...
Locator: getByRole('listitem').filter({ hasText: 'Archive Habit 1789710960309' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Archive Habit 1789710960309' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Archive Habit 1789710960309' })
