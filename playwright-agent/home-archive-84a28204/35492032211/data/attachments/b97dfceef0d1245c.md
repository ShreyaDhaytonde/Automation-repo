...
Locator:  getByRole('listitem').filter({ hasText: 'Test habit 1789883045174' }).locator('p.mt-1.text-xs.text-zinc-500.italic').filter({ hasText: 'Test note for habit' })
Expected: visible
Received: hidden
Timeout:  10000ms

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Test habit 1789883045174' }).locator('p.mt-1.text-xs.text-zinc-500.italic').filter({ hasText: 'Test note for habit' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Test habit 1789883045174' }).locator('p.mt-1.text-xs.text-zinc-500.italic').filter({ hasText: 'Test note for habit' })
...
- main:
  ...
  - list:
    - listitem:
      - paragraph: Test habit 1789883045174
      - text: Health
      - status "Test habit 1789883045174 is at risk of missing its weekly goal": ⏰ Due today
      - paragraph: Start your streak today!
      - progressbar "Test habit 1789883045174 weekly progress"
      - text: 0/3 this week
      - paragraph: Test note for habit
      - button "Mark done"
      - button "Freeze Test habit 1789883045174 for today": 🧊 Freeze
      - button "Edit Test habit 1789883045174": Edit
      - button "Duplicate Test habit 1789883045174": Duplicate
      - button "Archive Test habit 1789883045174": Archive
      - button "Delete Test habit 1789883045174": Remove
- alert
```
