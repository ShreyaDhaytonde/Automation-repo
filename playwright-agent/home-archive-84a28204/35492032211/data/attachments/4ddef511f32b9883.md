...
Locator:  getByRole('listitem').filter({ hasText: 'Daily completion habit 1789883033028' }).getByRole('button', { name: 'Done today', exact: true })
Expected: 1
Received: 0
Timeout:  10000ms

Call log:
  - Expect "toHaveCount" getByRole('listitem').filter({ hasText: 'Daily completion habit 1789883033028' }).getByRole('button', { name: 'Done today', exact: true }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Daily completion habit 1789883033028' }).getByRole('button', { name: 'Done today', exact: true })
  ...
  - main [ref=e3]:
    ...
    - list [ref=e36]:
      ...
      - listitem [ref=e71]:
        - generic:
          - generic:
            - paragraph [ref=e72]: Daily completion habit 1789883033028
            - generic [ref=e73]: General
            - status "Daily completion habit 1789883033028 is at risk of missing its weekly goal" [ref=e74]: ⏰ Due today
          - paragraph: Start your streak today!
          - generic:
        ...
        - generic [ref=e76]:
          ...
          - button "Freeze Daily completion habit 1789883033028 for today" [ref=e78]: 🧊 Freeze
          - button "Edit Daily completion habit 1789883033028" [ref=e79]: Edit
          - button "Duplicate Daily completion habit 1789883033028" [ref=e80]: Duplicate
          - button "Archive Daily completion habit 1789883033028" [ref=e81]: Archive
          - button "Delete Daily completion habit 1789883033028" [ref=e82]: Remove
  - alert [ref=e83]
```
