...
Locator: getByRole('listitem').filter({ hasText: 'Complete habit 1789886952701' }).getByRole('button', { name: 'Done today', exact: true })
Expected: disabled
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeDisabled" getByRole('listitem').filter({ hasText: 'Complete habit 1789886952701' }).getByRole('button', { name: 'Done today', exact: true }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Complete habit 1789886952701' }).getByRole('button', { name: 'Done today', exact: true })
...
- main:
  ...
  - list:
    ...
    - listitem:
      - paragraph: Complete habit 1789886952701
      - text: General
      - status "Complete habit 1789886952701 is at risk of missing its weekly goal": ⏰ Due today
      - paragraph: Start your streak today!
      - progressbar "Complete habit 1789886952701 weekly progress"
      - text: 0/7 this week
      - button "Mark done"
      - button "Freeze Complete habit 1789886952701 for today": 🧊 Freeze
      - button "Edit Complete habit 1789886952701": Edit
      - button "Duplicate Complete habit 1789886952701": Duplicate
      - button "Archive Complete habit 1789886952701": Archive
      - button "Delete Complete habit 1789886952701": Remove
    - listitem:
