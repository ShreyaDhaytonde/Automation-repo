...
Locator:  getByRole('listitem').filter({ hasText: 'Test Delete 1789886557634' })
Expected: 0
Received: 1
Timeout:  10000ms

Call log:
  - Expect "toHaveCount" getByRole('listitem').filter({ hasText: 'Test Delete 1789886557634' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Test Delete 1789886557634' })
    ...
    - list [ref=f1e12]:
      - listitem [ref=f1e13]:
        ...
        - generic [ref=f1e18]:
          ...
          - button "Delete Test Delete 1789886544739" [ref=f1e24]: Remove
      - listitem [ref=f1e25]:
        - generic:
          - generic:
            - paragraph [ref=f1e26]: Test Delete 1789886557634
            - generic [ref=f1e27]: General
            - status "Test Delete 1789886557634 is at risk of missing its weekly goal" [ref=f1e28]: ⏰ Due today
          - paragraph: Start your streak today!
          - generic:
            - progressbar "Test Delete 1789886557634 weekly progress"
            - generic [ref=f1e29]: 0/7 this week
        - generic [ref=f1e30]:
          - button "Mark done" [disabled] [ref=f1e31]
          - button "Freeze Test Delete 1789886557634 for today" [disabled] [ref=f1e32]: 🧊 Freeze
          - button "Edit Test Delete 1789886557634" [ref=f1e33]: Edit
          - button "Duplicate Test Delete 1789886557634" [ref=f1e34]: Duplicate
          - button "Unarchive Test Delete 1789886557634" [ref=f1e35]: Unarchive
          - button "Delete Test Delete 1789886557634" [active] [ref=f1e36]: Remove
  - alert [ref=f1e37]
```
