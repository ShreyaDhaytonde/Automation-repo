...
Locator:  getByRole('listitem').filter({ hasText: 'Daily completion habit 1789882243604' }).getByRole('button', { name: 'Done today', exact: true })
Expected: 1
Received: 0
Timeout:  10000ms

Call log:
  - Expect "toHaveCount" getByRole('listitem').filter({ hasText: 'Daily completion habit 1789882243604' }).getByRole('button', { name: 'Done today', exact: true }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Daily completion habit 1789882243604' }).getByRole('button', { name: 'Done today', exact: true })
  ...
  - main [ref=e3]:
    ...
    - list [ref=e36]:
      ...
      - listitem [ref=e49]:
        - generic:
          - generic:
            - paragraph [ref=e50]: Test Delete 1789881852026
            - generic [ref=e51]: General
            - status "Test Delete 1789881852026 is at risk of missing its weekly goal" [ref=e52]: ⏰ Due today
          - paragraph: Start your streak today!
          - generic:
        ...
        - generic [ref=e54]:
          ...
          - button "Freeze Test Delete 1789881852026 for today" [ref=e56]: 🧊 Freeze
          - button "Edit Test Delete 1789881852026" [ref=e57]: Edit
          - button "Duplicate Test Delete 1789881852026" [ref=e58]: Duplicate
          - button "Archive Test Delete 1789881852026" [ref=e59]: Archive
          - button "Delete Test Delete 1789881852026" [ref=e60]: Remove
      - listitem [ref=e61]:
        - generic:
          - generic:
            - paragraph [ref=e62]: Test Delete 1789881864356
            - generic [ref=e63]: General
            - status "Test Delete 1789881864356 is at risk of missing its weekly goal" [ref=e64]: ⏰ Due today
          - paragraph: Start your streak today!
          - generic:
        ...
        - generic [ref=e66]:
          ...
          - button "Freeze Test Delete 1789881864356 for today" [ref=e68]: 🧊 Freeze
          - button "Edit Test Delete 1789881864356" [ref=e69]: Edit
          - button "Duplicate Test Delete 1789881864356" [ref=e70]: Duplicate
          - button "Archive Test Delete 1789881864356" [ref=e71]: Archive
          - button "Delete Test Delete 1789881864356" [ref=e72]: Remove
      - listitem [ref=e73]:
        - generic:
          - generic:
            - paragraph [ref=e74]: Test Edit 1789881901537
            - generic [ref=e75]: General
            - status "Test Edit 1789881901537 is at risk of missing its weekly goal" [ref=e76]: ⏰ Due today
          - paragraph: Start your streak today!
          - generic:
        ...
        - generic [ref=e78]:
          ...
          - button "Freeze Test Edit 1789881901537 for today" [ref=e80]: 🧊 Freeze
          - button "Edit Test Edit 1789881901537" [ref=e81]: Edit
          - button "Duplicate Test Edit 1789881901537" [ref=e82]: Duplicate
          - button "Archive Test Edit 1789881901537" [ref=e83]: Archive
          - button "Delete Test Edit 1789881901537" [ref=e84]: Remove
  - alert [ref=e85]
```
