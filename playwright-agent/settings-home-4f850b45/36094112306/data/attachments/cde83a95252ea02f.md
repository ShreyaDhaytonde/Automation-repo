...
- Name: home.spec.ts >> Home >> TC76 - Filters - toggle show archived habits
- Location: tests/home.spec.ts:1434:7
...
> 1438 |     await expect(page.getByRole('list')).toBeVisible();
  ...
  1529 |     const filteredHabitCard = habitCardLocator(page, uniqueSearch);
  1530 |     await expect(filteredHabitCard).toBeVisible();
  1531 |   });
  1532 | 
  1533 |   /**
  1534 |    * TC84: Home - sort habits by different criteria
  1535 |    */
  1536 |   test('TC84 - Home - sort habits by different criteria', async ({ page }) => {
  1537 |     await page.goto('/');
  1538 |     const habitNameA = `AAA-${Date.now()}`;
```