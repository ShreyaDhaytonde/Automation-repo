...
- Name: home.spec.ts >> Home >> TC73 - Complete all - complete all pending habits for today
- Location: tests/home.spec.ts:1389:7
...
Locator: getByRole('listitem').filter({ hasText: 'CompleteAll1 1790311287071' }).getByRole('button', { name: 'Done today' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'CompleteAll1 1790311287071' }).getByRole('button', { name: 'Done today' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'CompleteAll1 1790311287071' }).getByRole('button', { name: 'Done today' })
...
- main:
  ...
  - button "Export CSV"
  - button "Import CSV"
  - paragraph: Completed 1/6 habits — 5 failed. Try again.
- alert
```
