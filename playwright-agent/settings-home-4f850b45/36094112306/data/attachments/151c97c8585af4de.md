...
Locator: getByRole('listitem').filter({ hasText: 'CompleteAll1 1790311274241' }).getByRole('button', { name: 'Done today' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'CompleteAll1 1790311274241' }).getByRole('button', { name: 'Done today' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'CompleteAll1 1790311274241' }).getByRole('button', { name: 'Done today' })
...
- main:
  ...
  - button "Export CSV"
  - button "Import CSV"
  - paragraph: Completed 5/6 habits — 1 failed. Try again.
- alert
```
