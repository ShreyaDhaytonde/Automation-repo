...
Locator: getByRole('listitem').filter({ hasText: 'Archive habit 1790050668246' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'Archive habit 1790050668246' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Archive habit 1790050668246' })
