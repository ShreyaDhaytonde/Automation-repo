...
- Name: home.spec.ts >> Home >> TC17 - HabitCard - removes a habit after confirm dialog
...
Locator: getByRole('listitem').filter({ hasText: 'DeleteTest 1790050222218' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'DeleteTest 1790050222218' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'DeleteTest 1790050222218' })
