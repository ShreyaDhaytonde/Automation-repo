...
- Name: home.spec.ts >> Home >> TC15 - HabitCard - marks a habit as done today button disables afterward
- Location: tests/home.spec.ts:265:7
...
Locator: getByRole('listitem').filter({ hasText: 'CompleteTest 1790050185996' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'CompleteTest 1790050185996' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'CompleteTest 1790050185996' })
