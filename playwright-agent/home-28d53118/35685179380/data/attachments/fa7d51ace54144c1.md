...
- Name: home.spec.ts >> Home >> TC19 - Category filter - filters habit list by category
- Location: tests/home.spec.ts:328:7
...
Locator: getByRole('listitem').filter({ hasText: 'CategoryTest 1790050246432' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('listitem').filter({ hasText: 'CategoryTest 1790050246432' }) with timeout 10000ms
  - waiting for getByRole('listitem').filter({ hasText: 'CategoryTest 1790050246432' })
