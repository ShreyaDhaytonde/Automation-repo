...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Skip Habit 1790068213574' }).getByRole('button', { name: 'Skip Skip Habit 1790068213574' })
  ...
  - main [ref=e3]:
    - generic [ref=e4]:
      - generic [ref=e5]:
        ...
        - paragraph [ref=e9]: 2/5 done today
      - generic [ref=e10]:
    ...
    - list [ref=e41]:
      ...
      - listitem [ref=e81]:
        - generic:
          - generic:
            - button "Pin Test Archived Duplicate Button 1790068079828 (copy)" [ref=e82]: ☆
            - paragraph [ref=e83]: Test Archived Duplicate Button 1790068079828 (copy)
            - generic [ref=e84]: General
            - button "Cycle priority for Test Archived Duplicate Button 1790068079828 (copy), currently Medium" [ref=e85]: Medium
            - status "Test Archived Duplicate Button 1790068079828 (copy) is at risk of missing its weekly goal" [ref=e86]: ⏰ Due today
          - paragraph: Start your streak today!
          - generic:
        ...
        - generic [ref=e88]:
          ...
          - button "Freeze Test Archived Duplicate Button 1790068079828 (copy) for today" [ref=e90]: 🧊 Freeze
          - button "Edit Test Archived Duplicate Button 1790068079828 (copy)" [ref=e91]: Edit
          - button "Duplicate Test Archived Duplicate Button 1790068079828 (copy)" [ref=e92]: Duplicate
          - button "Archive Test Archived Duplicate Button 1790068079828 (copy)" [ref=e93]: Archive
          - button "Delete Test Archived Duplicate Button 1790068079828 (copy)" [ref=e94]: Remove
      - listitem [ref=e95]:
        - generic:
          - generic:
            - button "Pin Test Unarchive 1790068082943" [ref=e96]: ☆
            - paragraph [ref=e97]: Test Unarchive 1790068082943
            - generic [ref=e98]: General
            - button "Cycle priority for Test Unarchive 1790068082943, currently Medium" [ref=e99]: Medium
          - paragraph: 🔥 1 day streak
          - generic:
        ...
        - generic [ref=e101]:
          ...
          - button "Freeze Test Unarchive 1790068082943 for today" [disabled] [ref=e103]: 🧊 Freeze
          - button "Edit Test Unarchive 1790068082943" [ref=e104]: Edit
          - button "Duplicate Test Unarchive 1790068082943" [ref=e105]: Duplicate
          - button "Archive Test Unarchive 1790068082943" [ref=e106]: Archive
          - button "Delete Test Unarchive 1790068082943" [ref=e107]: Remove
  - alert [ref=e108]
```
