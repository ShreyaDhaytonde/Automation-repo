...
test.describe('Archive', () => {
  ...
  /**
   * TC01: Archive - page loads with unconditional elements visible
   */
  test('TC01 - Archive - page loads with unconditional elements visible', async ({ page }) => {
  ...
  /**
   * TC07: Archive page - renders with heading and controls
   */
  test('TC07 - Archive page - renders with heading and controls', async ({ page }) => {
    await page.goto('/archive');
    await expect(page.getByRole('heading', { name: 'Archive' })).toBeVisible();
  ...
  /**
   * TC08: Archive page - create and unarchive a habit
   */
  test('TC08 - Archive page - create and unarchive a habit', async ({ page }) => {
  ...
  /**
   * TC09: Archive page - edit an archived habit\\\'s name
   */
  test('TC09 - Archive page - edit an archived habit\\\\\\\'s name', async ({ page }) => {
  ...
  /**
   * TC10: Archive page - delete an archived habit
   */
  test('TC10 - Archive page - delete an archived habit', async ({ page }) => {
  ...
  /**
   * TC11: History page - renders with heading and controls
   */
  test('TC11 - History page - renders with heading and controls', async ({ page }) => {
  ...
  /**
   * TC12: Home page - renders with heading and controls
   */
  test('TC12 - Home page - renders with heading and controls', async ({ page }) => {
    await page.goto('/');
    await expect(page.getByRole('heading', { name: 'Habit Tracker' })).toBeVisible();
  ...
  /**
   * TC13: History page - habit strips render and show status dots
   */
  test('TC13 - History page - habit strips render and show status dots', async ({ page }) => {
  ...
  /**
   * TC14: Archive page - error message appears when loading fails (non-deterministic)
   */
  test('TC14 - Archive page - error message appears when loading fails (non-deterministic)', async ({ page }) => {
    await page.goto('/archive');
    await expect(page.locator('text=Could not load archived habits. Is the API running?')).toBeHidden();
  });

  /**
   * TC15: Archive page - empty state message is shown when no habits are archived (not reachable without backend control)
   */
  test('TC15 - Archive page - empty state message is shown when no habits are archived (not reachable without backend control)', async ({ page }) => {
    await page.goto('/archive');
