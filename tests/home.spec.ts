...
test.describe('Home', () => {
  ...
  /**
   * TC01: Home page - loads with heading and main controls visible
   */
  test('TC01 - Home page - loads with heading and main controls visible', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC02: Habit form - adds a new habit successfully
   */
  test('TC02 - Habit form - adds a new habit successfully', async ({ page }) => {
    await page.goto("/");
    ...
    await page.getByLabel("Notes (optional)").fill("Testing notes");
    await page.getByRole("button", { name: "Add habit" }).click();
    const createdHabit = page.getByRole("listitem").filter({ hasText: habitName });
    await expect(createdHabit).toBeVisible();
    await expect(createdHabit.getByText("Health")).toBeVisible();
    await expect(createdHabit.getByText("3x / week")).toBeVisible();
    await expect(createdHabit.getByText("Testing notes")).toBeVisible();
  });

  // ──────────────────────────────────────────────────────────────────────────
  // SECTION 3: Habit duplication
  // ──────────────────────────────────────────────────────────────────────────

  /**
   * TC03: Habit card - duplicates a habit from the home page
   */
  test('TC03 - Habit card - duplicates a habit from the home page', async ({ page }) => {
    await page.goto("/");
    const baseName = `Duplicate Habit ${Date.now()}`;
    await page.getByLabel("New habit name").fill(baseName);
    await page.getByRole("button", { name: "Add habit" }).click();
    const originalHabit = page.getByRole("listitem").filter({ hasText: baseName });
    await expect(originalHabit).toBeVisible();
    await originalHabit.getByRole("button", { name: `Duplicate ${baseName}` }).click();
    const duplicateName = `${baseName} (copy)`;
    const duplicateHabit = page.getByRole("listitem").filter({ hasText: duplicateName });
    await expect(duplicateHabit).toBeVisible();
  });
  ...
  /**
   * TC04: Filter controls - clear filters button resets filters to defaults
   */
  test('TC04 - Filter controls - clear filters button resets filters to defaults', async ({ page }) => {
    await page.goto("/");
    await page.getByRole("textbox", { name: "Search habits by name" }).fill("nonexistent-filter-test");
    ...
    await expect(page.getByRole("checkbox", { name: "Show archived" })).not.toBeChecked();
  ...
  /**
   * TC05: Home - page loads with unconditional elements visible
   */
  test('TC05 - Home - page loads with unconditional elements visible', async ({ page }) => {
    await page.goto('/');
    await expect(page.getByRole('heading', { name: 'Habit Tracker' })).toBeVisible();
  ...
  /**
   * TC06: HabitForm - adds a new habit successfully
   */
  test('TC06 - HabitForm - adds a new habit successfully', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC07: HabitCard - edits a habit\'s name, category, target per week, and notes successfully
   */
  test('TC07 - HabitCard - edits a habit\\\'s name, category, target per week, and notes successfully', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC08: HabitCard - marks a habit as done today button disables afterward
   */
  test('TC08 - HabitCard - marks a habit as done today button disables afterward', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC09: HabitCard - archives and unarchives a habit
   */
  test('TC09 - HabitCard - archives and unarchives a habit', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC10: HabitCard - removes a habit after confirm dialog
   */
  test('TC10 - HabitCard - removes a habit after confirm dialog', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC11: Search box - filters habit list by matching name
   */
  test('TC11 - Search box - filters habit list by matching name', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC12: Category filter - filters habit list by category
   */
  test('TC12 - Category filter - filters habit list by category', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC13: Sort by dropdown - sorts habit list by name ascending
   */
  test('TC13 - Sort by dropdown - sorts habit list by name ascending', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC14: HabitForm - disables Add habit button when name is empty
   */
  test('TC14 - HabitForm - disables Add habit button when name is empty', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC15: Home page - page loads and renders unconditional elements
   */
  test('TC15 - Home page - page loads and renders unconditional elements', async ({ page }) => {
    await page.goto("/");
    await expect(page.getByRole("heading", { name: "Habit Tracker" })).toBeVisible();
  ...
  /**
   * TC16: HabitCard - inline edit form displays when Edit button clicked and updates fields
   */
  test('TC16 - HabitCard - inline edit form displays when Edit button clicked and updates fields', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC17: HabitForm - form validation disables Add habit button for empty name
   */
  test('TC17 - HabitForm - form validation disables Add habit button for empty name', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC18: HabitCard - cancel edit closes inline form without saving changes
   */
  test('TC18 - HabitCard - cancel edit closes inline form without saving changes', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC19: HabitCard - Save button disabled when name input is empty or blank
   */
  test('TC19 - HabitCard - Save button disabled when name input is empty or blank', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC20: Page heading and static elements render
   */
  test('TC20 - Page heading and static elements render', async ({ page }) => {
    await page.goto("/");
    await expect(page.getByRole("heading", { name: "Habit Tracker" })).toBeVisible();
    await expect(page.getByText("Build small daily habits, one day at a time.")).toBeVisible();
    await expect(page.getByLabel("Filter by category")).toBeVisible();
  ...
  /**
   * TC21: HabitForm - allows creating a new habit
   */
  test('TC21 - HabitForm - allows creating a new habit', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC22: Category filter - allows filtering habits
   */
  test('TC22 - Category filter - allows filtering habits', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC24: HabitCard inline edit form - opens and cancels edit mode
   */
  test('TC24 - HabitCard inline edit form - opens and cancels edit mode', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC25: HabitCard inline edit form - saves edited habit and closes form
   */
  test('TC25 - HabitCard inline edit form - saves edited habit and closes form', async ({ page }) => {
    await page.goto("/");
  ...
  /**
   * TC26: Home page - initial render shows main heading, filter, show archived checkbox, export buttons disabled, and navigation link
   */
  test('TC26 - Home page - initial render shows main heading, filter, show archived checkbox, export buttons disabled, and navigation link', async ({ page }) => {
    await page.goto('/');
    await expect(page.getByRole('heading', { name: 'Habit Tracker' })).toBeVisible();
  ...
  /**
   * TC27: HabitForm - create a habit with notes successfully adds it to the list and enables export buttons
   */
  test('TC27 - HabitForm - create a habit with notes successfully adds it to the list and enables export buttons', async ({ page }) => {
    await page.goto('/');
    const habitName = `Test habit ${Date.now()}`;
  ...
  /**
   * TC28: HabitCard - edit habit updates name, category, target per week, and notes
   */
  test('TC28 - HabitCard - edit habit updates name, category, target per week, and notes', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC29: HabitCard - archive and unarchive a habit via its archive toggle button
   */
  test('TC29 - HabitCard - archive and unarchive a habit via its archive toggle button', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC30: HabitCard - mark habit as done disables mark done button
   */
  test('TC30 - HabitCard - mark habit as done disables mark done button', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC31: Home - filter habits list by category changes displayed habits accordingly
   */
  test('TC31 - Home - filter habits list by category changes displayed habits accordingly', async ({ page }) => {
    await page.goto('/');
    const categoryFilter = page.getByLabel('Filter by category');
  ...
  /**
   * TC32: Home - toggling show archived checkbox updates displayed habits accordingly
   */
  test('TC32 - Home - toggling show archived checkbox updates displayed habits accordingly', async ({ page }) => {
    await page.goto('/');
    const showArchivedCheckbox = page.getByLabel('Show archived');
    await showArchivedCheckbox.check();
  ...
  /**
   * TC33: Home - Export JSON and Export CSV buttons are disabled when no habits exist and enabled after habits are created
   */
  test('TC33 - Home - Export JSON and Export CSV buttons are disabled when no habits exist and enabled after habits are created', async ({ page }) => {
    await page.goto('/');
    const exportJsonButton = page.getByRole('button', { name: 'Export JSON' });
    const exportCsvButton = page.getByRole('button', { name: 'Export CSV' });
    await expect(exportJsonButton).toBeDisabled();
  ...
  /**
   * TC34: LogoutButton - logout button logs out and navigates to /login
   */
  test('TC34 - LogoutButton - logout button logs out and navigates to /login', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC35: Home page - page loads and displays unconditional controls
   */
  test('TC35 - Home page - page loads and displays unconditional controls', async ({ page }) => {
    await page.goto('/');
    await expect(page.getByRole('heading', { name: 'Habit Tracker' })).toBeVisible();
    await expect(page.getByLabel('New habit name')).toBeVisible();
    await expect(page.getByLabel('Habit category')).toBeVisible();
  ...
  /**
   * TC36: HabitForm - add new habit successfully resets form
   */
  test('TC36 - HabitForm - add new habit successfully resets form', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC37: HabitCard - edit habit and save changes updates displayed name and disables save button when empty
   */
  test('TC37 - HabitCard - edit habit and save changes updates displayed name and disables save button when empty', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC38: Home page - search filters habit list results
   */
  test('TC38 - Home page - search filters habit list results', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC39: Home page - category filter updates visible habits
   */
  test('TC39 - Home page - category filter updates visible habits', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC40: Home page - toggling show archived controls archived habits visibility
   */
  test('TC40 - Home page - toggling show archived controls archived habits visibility', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC41: Home page - Complete all for today bulk action disables button and updates label
   */
  test('TC41 - Home page - Complete all for today bulk action disables button and updates label', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC42: Home page - Export JSON and CSV buttons visibility and disabled state
   */
  test('TC42 - Home page - Export JSON and CSV buttons visibility and disabled state', async ({ page }) => {
    await page.goto('/');
    const exportJsonButton = page.getByRole('button', { name: 'Export JSON' });
    const exportCsvButton = page.getByRole('button', { name: 'Export CSV' });
    await expect(exportJsonButton).toBeVisible();
  ...
  /**
   * TC43: HabitForm - creates a new habit successfully
   */
  test('TC43 - HabitForm - creates a new habit successfully', async ({ page }) => {
    await page.goto('/');
    const habitName = `Test Habit ${Date.now()}`;
    await page.getByLabel('New habit name').fill(habitName);
    await page.getByLabel('Habit category').selectOption('General');
  ...
  /**
   * TC44: HabitCard - edits an existing habit\\\'s name, category, target per week, and notes
   */
  test('TC44 - HabitCard - edits an existing habit\\\\\\\'s name, category, target per week, and notes', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC45: HabitCard - marks a habit as completed today
   */
  test('TC45 - HabitCard - marks a habit as completed today', async ({ page }) => {
    await page.goto('/');
    const habitName = `Complete Habit ${Date.now()}`;
    await page.getByLabel('New habit name').fill(habitName);
    await page.getByRole('button', { name: 'Add habit' }).click();
  ...
  /**
   * TC46: HabitCard - toggles archive and unarchive of a habit
   */
  test('TC46 - HabitCard - toggles archive and unarchive of a habit', async ({ page }) => {
    await page.goto('/');
    const habitName = `Archive Habit ${Date.now()}`;
    await page.getByLabel('New habit name').fill(habitName);
    const addButton = page.getByRole('button', { name: 'Add habit' });
  ...
  /**
   * TC47: Home - filters habits by category
   */
  test('TC47 - Home - filters habits by category', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC48: Home - searches for habits by name
   */
  test('TC48 - Home - searches for habits by name', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC49: Home - sorts habits by different criteria updates visible list
   */
  test('TC49 - Home - sorts habits by different criteria updates visible list', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC50: Home - toggles show archived checkbox updates habits list
   */
  test('TC50 - Home - toggles show archived checkbox updates habits list', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC51: Home - completes all incomplete habits for today with bulk action
   */
  test('TC51 - Home - completes all incomplete habits for today with bulk action', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC52: Home page - initial render with unconditional elements
   */
  test('TC52 - Home page - initial render with unconditional elements', async ({ page }) => {
    await page.goto("/");
    await expect(page.getByRole("heading", { name: "Habit Tracker" })).toBeVisible();
    await expect(page.getByLabel("Search habits by name")).toBeVisible();
    await expect(page.getByRole("button", { name: /Complete all for today/ })).toBeVisible();
