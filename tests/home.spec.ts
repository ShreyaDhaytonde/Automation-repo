...
test.describe('Home', () => {
  ...
  /**
   * TC02: HabitCard in Home - duplicates a habit and sees the duplicate added to the list
   */
  test('TC02 - HabitCard in Home - duplicates a habit and sees the duplicate added to the list', async ({ page }) => {
    await page.goto("/");
