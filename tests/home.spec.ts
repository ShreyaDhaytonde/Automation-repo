...
test.describe('Home', () => {
  ...
  /**
   * TC01: Home - page loads with unconditional elements
   */
  ...
  /**
   * TC02: Home - clicking clear filters resets all filters to default
   */
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // SECTION 3: Completion progress display
  // ──────────────────────────────────────────────────────────────────────────

  /**
   * TC03: Home - shows completion progress when habits exist
   */
  ...
  /**
   * TC04: Home - shows clear filters button when filters are active
   */
  test('TC04 - Home - shows clear filters button when filters are active', async ({ page }) => {
    await page.goto('/');
  ...
  /**
   * TC52: Home page - loads and renders main UI elements
   */
  test('TC52 - Home page - loads and renders main UI elements', async ({ page }) => {
    await page.goto('/');
    await expect(page.getByRole('heading', { name: 'Habit Tracker' })).toBeVisible();
    await expect(page.getByLabel('Search habits by name')).toBeVisible();
    await expect(page.getByLabel('Sort habits by')).toBeVisible();
  ...
  /**
   * TC53: HabitCard - duplicates a habit and appends the copy with \' (copy)\' suffix
   */
  ...
  /**
   * TC55: Home page - initial render with unconditional elements
   */
  test('TC55 - Home page - initial render with unconditional elements', async ({ page }) => {
    await page.goto("/");
    await expect(page.getByRole("heading", { name: "Habit Tracker" })).toBeVisible();
    await expect(page.getByLabel("Search habits by name")).toBeVisible();
    await expect(page.getByRole("button", { name: /Complete all for today/ })).toBeVisible();
