...
test.describe('Login Page', () => {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // SECTION 1: Page load and form display
  // ──────────────────────────────────────────────────────────────────────────

  /**
   * TC01: Login Page - loads and displays form controls
   */
  test('TC01 - Login Page - loads and displays form controls', async ({ page }) => {
  ...
  /**
   * TC02: Login Page - successful login with valid credentials navigates to home
   */
  test('TC02 - Login Page - successful login with valid credentials navigates to home', async ({ page }) => {
    await page.goto('/login');
  ...
  /**
   * TC03: Login Page - shows error on invalid credentials
   */
  test('TC03 - Login Page - shows error on invalid credentials', async ({ page }) => {
    await page.goto('/login');
