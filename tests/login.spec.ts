...
test.describe('Login', () => {
  ...
  /**
   * TC01: Login Page - initial render shows heading and empty inputs
   */
  test('TC01 - Login Page - initial render shows heading and empty inputs', async ({ page }) => {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // SECTION 2: Login Form submission
  // ──────────────────────────────────────────────────────────────────────────

  /**
   * TC02: Login Page - successful login redirects to home page
   */
  test('TC02 - Login Page - successful login redirects to home page', async ({ page }) => {
    await page.goto('/login');
  ...
  /**
   * TC03: Login Page - shows error message on invalid login attempt
   */
  test('TC03 - Login Page - shows error message on invalid login attempt', async ({ page }) => {
    await page.goto('/login');
