...
test.describe('Login', () => {
  ...
  /**
   * TC01: Login Page - initial render shows form and elements
   */
  test('TC01 - Login Page - initial render shows form and elements', async ({ page }) => {
  ...
  /**
   * TC03: Login Page - shows error message on invalid credentials
   */
  test('TC03 - Login Page - shows error message on invalid credentials', async ({ page }) => {
    await page.goto('/login');
