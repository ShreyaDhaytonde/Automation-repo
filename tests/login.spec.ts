...
test.describe('Login', () => {
  ...
  /**
   * TC01: LoginPage - renders heading and inputs on initial load
   */
  test('TC01 - LoginPage - renders heading and inputs on initial load', async ({ page }) => {
  ...
  /**
   * TC02: LoginPage - successfully logs in with valid credentials and navigates to home
   */
  test('TC02 - LoginPage - successfully logs in with valid credentials and navigates to home', async ({ page }) => {
    await page.goto('/login');
    ...
    expect(cookies.some(cookie => cookie.name === 'habit_auth' && cookie.value === '1')).toBeTruthy();
  });
  ...
  /**
   * TC03: LoginPage - shows error message on invalid credentials
   */
  test('TC03 - LoginPage - shows error message on invalid credentials', async ({ page }) => {
    await page.goto('/login');
